...
6. ✅ **ESLint warnings are treated as errors in CI** — the example `lint` script above uses `--max-warnings 0` by design; run `npm run lint` locally to match CI behavior exactly
